...
public class DaysHorizontalView extends RelativeLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attr ) {
        ...
        viewPager.setPadding(HodooUtil.dpToPx(getContext(), 50), 0, HodooUtil.dpToPx(getContext(), 50), 0);
        params.addRule(RelativeLayout.ALIGN_LEFT);

        preBtn = new ImageView(getContext());
...
//        scrollView = new ViewPager(getContext());
